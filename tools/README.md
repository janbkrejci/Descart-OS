...
Before proceeding, I will use the `collect_folder_instructions` tool to efficiently read only the frontmatter from all README.md files in the subdirectories to understand the structure and locate resources for future reference when needed.