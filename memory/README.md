...
Before proceeding, I will use the `collect_folder_instructions` tool to efficiently read only the frontmatter from all README.md files in all subdirectories to understand what information is stored where, so I can return to it later if needed.