---
name: background-shell-execution
description: Skill for executing commands in background using tmux via bash and processing their output.
---

# Executing Shell Commands in tmux

This skill prescribes how I execute background shell commands requested by the user using the `bash` tool with `tmux`, and how I retrieve and process their output.
