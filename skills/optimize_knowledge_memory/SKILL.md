---
name: optimize_knowledge_memory
...
6. After optimization, I will briefly summarize the changes to the user if they explicitly requested it, or log it silently if autonomous.
