...
Before proceeding, I will use the `collect_folder_instructions` tool to efficiently read only the frontmatter from all README.md files in subdirectories to understand what I can find where and enable me to reference it later if needed.