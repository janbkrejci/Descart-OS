...
3. I will fully delegate the generation and saving of the script to the `generate_script` tool, adhering to its rules.
4. I will present the result to the user clearly, informing them where the script is located, how to execute it, and what it does.
